      ...
      <div style={{ maxWidth: 784, margin: "0 auto" }}>
        ...
        <div id="how-to-use" style={{ marginTop: 80, paddingLeft: 4 }}>
          ...
          <p style={{ ...tokens.type.md, color: dimColor, margin: "0 0 12px", lineHeight: 1.7, transition: t("color") }}>
            Halaska Kit is a UX pattern and component library for AI products, built by <StudioLink theme={pageTheme} /> on shadcn/ui foundations — designed to make prototypes of agents, copilots, and AI workflows look and feel like real products, not generic output.
          </p>
...
1. Download the kit into src/: curl -o src/halaska-kit.jsx https://kit.halaskastudio.com/halaska-kit.jsx (ask me for the file if the URL is unreachable).
